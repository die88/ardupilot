...
void Copter::ptam_tray_run()
{
    ...
    control_alt=sat_die(-g.kp_ptam_alt*(ptam_pos_vel[2]-ptam_pos_target[2])-g.kd_ptam_alt*ptam_pos_vel[5],MAX_PTAM_ALT,-MAX_PTAM_ALT); //missing target speed, zero by now
